module AuthenticatedSystem
  protected
    ...
    def current_user
      @current_user ||= (login_from_session || login_from_basic_auth || login_from_cookie) unless 		
			@current_user == false
    end
    ...
    def access_denied
      ...
      respond_to do |format|
        ...
        format.xml do
          ...
          render :text => "Você não possui permissão para esta ação.", :status => '401 Unauthorized'
        end
      end
    end
